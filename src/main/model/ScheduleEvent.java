...
public class ScheduleEvent implements Comparable<ScheduleEvent>, Writable {
    ...
    public ScheduleEvent(String eventName, int startHour, int startMinute, int endHour, int endMinute) {
